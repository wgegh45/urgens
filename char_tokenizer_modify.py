...
class CharTokenizer(PreTrainedTokenizer):
    ...
    @overload
    def __call__(self, texts: str, max_len=None, padding=False, truncation=False) -> Dict:
        ...
    @overload
    def __call__(self, texts: list, max_len=None, padding=False, truncation=False) -> Dict:
        ...
    def __call__(self, texts, max_len=None, padding=False, truncation=False) -> Dict:
        if not padding:
            if type(texts) == str:
                input_ids = self.encode(texts)
                # truncation処理を追加
                if truncation and max_len and len(input_ids) > max_len:
